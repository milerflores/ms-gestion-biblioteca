...
import pe.edu.idat.ms_biblioteca.security.CustomAccessDeniedHandler;
import pe.edu.idat.ms_biblioteca.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/v1/libros/**").hasAnyRole("USUARIO", "ADMIN")
